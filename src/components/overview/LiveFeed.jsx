      ...
      >
        ...
        {showsBoxes && scaleX > 0 && scaleY > 0 && (USE_MOCK_DATA || feedOk) && (
          <div className="absolute inset-0">
            {/* Entrada/salida con motion (aporte de Sheila): las cajas
                aparecen/desaparecen con un pop en vez de saltar de golpe --
                se nota mas en modo real, donde las detecciones cambian frame
                a frame. Azul/coral: el único par de identidad validado para
                daltonismo, por eso lo usamos aquí aunque haya varios limones
                en pantalla a la vez (nunca teal junto a coral, ver notas de paleta). */}
            <AnimatePresence>
